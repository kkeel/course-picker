...
(function () {
  ...
  { key: "lesson-plans", label: "Lesson Plans", href: "lesson-plans.html", status: "ready", icon: "lesson-plans.svg", audience: "member" },
  ...
  { key: "tracker", label: "Readiness Tracker", href: "tracker.html", status: "ready", icon: "readiness-tracker.svg", group: "Other tools", audience: "staff" },
];
